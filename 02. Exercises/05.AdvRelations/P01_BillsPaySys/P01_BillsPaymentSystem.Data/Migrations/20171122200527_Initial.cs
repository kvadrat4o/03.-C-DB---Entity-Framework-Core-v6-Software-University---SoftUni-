        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Balance = table.Column<decimal>(type: "decimal(18, 2)", unicode: false, nullable: false),
            ...
            migrationBuilder.Sql("ALTER TABLE PaymentMethods ADD CONSTRAINT Ck_CreditCardId_BankAccountId CHECK((CreditCardId IS NULL AND BankAccountId IS NOT NULL) OR(CreditCardId IS NOT NULL AND BankAccountId IS NULL))");
        }
